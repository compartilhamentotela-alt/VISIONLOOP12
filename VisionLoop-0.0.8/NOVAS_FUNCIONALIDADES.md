...
> A partir da v0.0.8, o servidor não detecta mais `.mkv`, `.mov` e `.avi` no upload — todo vídeo já chega (ou é convertido) como `.mp4`/`.webm` antes disso, então essa checagem de formatos antigos foi removida. Veja o changelog no `README.md`.
